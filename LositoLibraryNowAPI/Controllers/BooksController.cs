using LositoLibraryNowAPI.Models;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace LositoLibraryNowAPI.Controllers
{
    [Route("api/v1/books")]
    [ApiController]
    public class BooksController : ControllerBase
    {
        ...
        {
            new Books { Id = 1, Title = "The Midnight Library", Author = "Matt Haig", Genre = "Fiction / Fantasy", Available = true, PublishedYear = 2020 },

            new Books { Id = 2, Title = "Atomic Habits", Author = "James Clear", Genre = "Self-Help", Available = false, PublishedYear = 2018 },
